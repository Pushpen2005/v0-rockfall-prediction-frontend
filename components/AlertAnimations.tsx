...
// Lightweight default Lottie JSON via URL is avoided to keep offline-friendly.
// Users can replace this with a preferred Lottie JSON import.
// Example free files from LottieFiles: bell alert, warning pulse, etc.
// Here we embed a tiny inline animation data (simplified) as a placeholder.
const minimalBell: any = {
  v: "5.7.6",
  fr: 30,
  ip: 0,
  op: 45,
...
export const SlideInPanel: React.FC<SlideInPanelProps> = ({ isOpen, onClose, title = "Alerts", children }) => {
  return (
    <AnimatePresence>
      {isOpen ? (
        <>
